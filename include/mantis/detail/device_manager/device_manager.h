...
namespace mantis {
    ...
    class device_manager {
      public:
         ...
         */
        mantis::errors::error_code init(int num, params::msdr_params msdr_params);
         ...
         * channel_num + 1)
         */
        std::pair<errors::error_code, go::mtx_channel::sptr> get_tx_channel(const params::msdr_params& msdr_params,
                                                                            size_t channel_num);
         ...
         * channel_num + 1)
         */
        std::pair<errors::error_code, go::mrx_channel::sptr> get_rx_channel(const params::msdr_params& msdr_params,
                                                                            size_t channel_num);
      ...
      private:
        ...
        static mantis::errors::error_code init_internal(int num, std::vector<go::msdr::sptr>& o_found_sdrs,
